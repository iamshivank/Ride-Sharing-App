...
exports.updateRideLocation = exports.getAvailableRides = exports.rateRide = exports.completeRide = exports.cancelRide = exports.getUserRides = exports.getRideById = exports.acceptRide = exports.requestRide = void 0;
const errorHandler_1 = require("../middlewares/errorHandler");
// Temporary data storage (will be replaced with Prisma)
const rides = [];
// Request a ride
exports.requestRide = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: userId } = req.user;
    const { pickupLocation, dropoffLocation, rideType = 'standard', estimatedPrice, estimatedDistance, estimatedDuration } = req.body;
...
// Accept a ride
exports.acceptRide = (0, errorHandler_1.catchAsync)(async (req, res) => {
...
// Get ride by ID
exports.getRideById = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: userId } = req.user;
    const { id: rideId } = req.params;
    // Find ride
...
// Get user's rides
exports.getUserRides = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: userId } = req.user;
...
// Cancel a ride
exports.cancelRide = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: userId } = req.user;
    const { id: rideId } = req.params;
...
// Complete a ride
exports.completeRide = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: driverId } = req.user;
    const { id: rideId } = req.params;
...
// Rate a ride
exports.rateRide = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: userId } = req.user;
    const { id: rideId } = req.params;
...
exports.getAvailableRides = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: driverId } = req.user;
...
exports.updateRideLocation = (0, errorHandler_1.catchAsync)(async (req, res) => {
    const { id: driverId } = req.user;
    const { id: rideId } = req.params;
    ...
    if (status) {
        ...
        if (allowedTransitions[rides[rideIndex].status] &&
